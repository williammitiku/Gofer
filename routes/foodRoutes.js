...
router.post("/create", authA, authRestaurant, foodController.create)
router.get("/getAll", authA,  foodController.getAll)
router.post("/getFoodByRestaurant", authA, authAdmins, foodController.getFoodByRestaurant)
router.post("/getFoodByCategory", authA, authRestaurant,  foodController.getFoodByCategory)
router.get("/getAllCategory", authA, authAdmins,  foodController.getAllCategory)
